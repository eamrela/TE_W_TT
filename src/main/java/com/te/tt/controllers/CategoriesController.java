...
public class CategoriesController implements Serializable {
    ...
    @EJB
    private com.te.tt.beans.CategoriesFacade ejbFacade;
    ...
    public Categories getCategories(java.lang.String id) {
